...
const reviews = [
  {
    id: 1,
    rate: 4,
    text: "لقد كانت تجربتنا مع الأزاز للحقائب مُذهلة، لقد ساهموا في تطوير علامتنا التجارية وزيادة مبيعاتنا بشكل ملحوظ. نحن ممتنون لشراكتهم القيمة.",
    user_image: "/assets/demo/1.jpg",
    user_name: "محمد السيد",
    user_desc: "مستشار تسويق رقمي في شركة الأزاز",
  },
  {
    id: 2,
    rate: 3,
